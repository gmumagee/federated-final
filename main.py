...
def parse_args() -> argparse.Namespace:
    ...
    # Read the config path first so YAML values can become argparse defaults.
...
def main() -> None:
    ...
    # Device selection honors the config file while still falling back safely.
    device = torch.device(
    ...
    # Save the final global model weights and plot inside a dedicated results folder.
